export default function OutcomeFocusSection({ headline, ctaLabel }) {
  return (
    <div
    ...
    >
      ...
      {/* CTA Button */}
      <button
        className="font-bold text-sm sm:text-base rounded-full px-6 py-3 sm:px-8 sm:py-4 border-0 cursor-pointer transition-colors duration-300 hover:bg-gray-900"

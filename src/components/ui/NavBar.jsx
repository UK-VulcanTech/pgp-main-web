...
function Dropdown({ label, links, isOpen, onToggle, onClose }) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={onToggle}
        className="flex items-center gap-1 text-sm font-medium text-gray-700 hover:text-[#1a3c5e] transition-colors duration-200 py-2"
      >
        {label}
        <svg
...
export default function NavBar() {
  ...
  const navLinkClass = "text-sm font-medium text-gray-700 py-2 cursor-default";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <span className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-xl font-bold text-[#1a3c5e]">Peak Global Partners</span>
          </span>
          {/* </Link> */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <span className="text-sm  px-4 py-2 text-black rounded-md cursor-default">
              Contact
            </span>
          </div>
        ...
        {mobileOpen && (
          <div className="lg:hidden border-t border-gray-100 py-3 space-y-1">
            ...
            {solutionsLinks.map((l) => (
              ...
              <span key={l.to} className="block px-6 py-2 text-sm text-gray-600 cursor-default">
                {l.label}
              </span>
            ))}
